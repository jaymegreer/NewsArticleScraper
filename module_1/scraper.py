...
class Scraper(ContentExtractor):
    ...
    def extract_content(self, url): #function to extract content from URL
        try:
            ...
            article_title = parsed_content.find('h1', {'class': 'article-hero-headline__htag'}).get_text() #find article header
            ...
            return article_text, article_title #return extracted and converted content and title
